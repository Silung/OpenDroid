                    ...
                    put(
                        ...
                        buildJsonObject {
                            ...
                            put(
                                "description",
                                JsonPrimitive(
                                    "Optional downscale cap (px) on the **longer** side (portrait phones: usually height). Range 64–16384; **default 16384** = keep native resolution (no shrink on normal devices). Lower values shrink proportionally together with maxShortEdge; never enlarged.",
                                ),
                            )
                        },
                    )
                    put(
                        ...
                        buildJsonObject {
                            ...
                            put(
                                "description",
                                JsonPrimitive(
                                    "Optional downscale cap (px) on the **shorter** side. Range 64–16384; **default 16384** = native resolution. Used with maxLongEdge; one scale factor for both dimensions.",
                                ),
                            )
                        },
                    )
